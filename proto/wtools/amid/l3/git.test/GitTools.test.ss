...
function commitsDatesWithOptionDelta( test )
{
  ...
  begin().then( () =>
  {
    test.case = 'relative - current, state2 - to last commit, positive delta, one hour un miliseconds';
    return _.git.commitsDates
    ({
      localPath : a.abs( '.' ),
      state1 : '#af36e28bc91b6f18e4babc810bbf5bc758ccf19f',
  ...
  begin().then( () =>
  {
    test.case = 'relative - current, state2 is not last commit, positive delta, one hour un miliseconds';
    return _.git.commitsDates
    ({
      localPath : a.abs( '.' ),
      state1 : '#af36e28bc91b6f18e4babc810bbf5bc758ccf19f',
  ...
  begin().then( () =>
  {
    test.case = 'relative - now, state2 - to last commit, positive delta, one hour un miliseconds';
    return _.git.commitsDates
    ({
      localPath : a.abs( '.' ),
      state1 : '#af36e28bc91b6f18e4babc810bbf5bc758ccf19f',
  ...
  begin().then( () =>
  {
    test.case = 'relative - now, state2 is not last commit, positive delta, one hour un miliseconds';
    return _.git.commitsDates
    ({
      localPath : a.abs( '.' ),
      state1 : '#af36e28bc91b6f18e4babc810bbf5bc758ccf19f',
  ...
  begin().then( () =>
  {
    test.case = 'relative - current, state2 - to last commit, negative delta, one hour un miliseconds';
    return _.git.commitsDates
    ({
      localPath : a.abs( '.' ),
      state1 : '#af36e28bc91b6f18e4babc810bbf5bc758ccf19f',
